...
class Settings(BaseSettings):
    ...
    enrichment_model: str = Field(default="gemini-2.5-flash", min_length=1)
    enrichment_max_concurrency: int = Field(default=10, ge=1)
    enrichment_temperature: float = Field(default=0.1, ge=0.0, le=2.0)
    enrichment_max_output_tokens: int = Field(default=512, ge=1)
    enrichment_min_chunk_tokens: int = Field(default=10, ge=1)
