...
Citation marker extraction from LLM output, source metadata resolution (URL and text citations), prompt citation instructions, SSE citations event emission, citation persistence, and configuration. Introduced by S4-03.
