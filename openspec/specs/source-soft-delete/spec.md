...
Source soft delete endpoint with draft chunk cascade, published chunk preservation, dual-field contract, warnings, idempotency, and scoped lookup. Introduced by S3-05.
