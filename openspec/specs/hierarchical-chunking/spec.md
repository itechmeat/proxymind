...
Parent-child chunking for qualifying long-form Path B and Path C documents, including structure-first grouping, bounded fallback grouping, canonical parent persistence, and hierarchy decision observability.
